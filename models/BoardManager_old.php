...
class BoardManager {
    ...
    function nextNsquare(string $column,string $line,string $direction,$n) {
    ...
    function previousNsquare(string $column,string $line,string $direction,$n) {
   ...
   function nextNposition(string $col,string $line,string $direction,$n) {
    ...
    function previousNposition(string $col,string $line,string $direction,$n) {
     ...
     function squareIsBlank(string $line,string $col) {
         $ok=false;
