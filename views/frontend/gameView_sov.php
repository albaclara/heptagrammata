...
if (! $endofgame) {
    ...
    if ($badcode) {
        ...
        ?>
            ...
            <input type="text" name="columnfirstletter" id="columnfirstletter" maxlength="2" size="2" />
            <label for="linefirstletter" ><?php echo $translation["Label_Line"]; ?> :</label>
            <input type="text" name="linefirstletter" id="linefirstletter" maxlength="2" size="2" /><br />
            ...
            <input type="button" id="miss" class="button1" name="miss" value="<?php echo $translation["Button_Miss"]; ?>">
